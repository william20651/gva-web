<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="areaId字段" prop="areaId" width="120" />
        <el-table-column align="left" label="parentId字段" prop="parentId" width="120" />
        <el-table-column align="left" label="name字段" prop="name" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateAreaFunc(scope.row)">变更</el-button>
